...
#./_mkthumb.sh ../thumbnail/gettysburg.jpeg gettysburg
#./_mkthumb.sh ${ORIG}/1799-rosettastone.jpeg rosettastone
#./_mkthumb.sh ${ORIG}/1972-lenna.tiff lenna
...
#./_mkthumb.sh ../thumbnail/elements.svg elements
./_mkthumb.sh ../thumbnail/electriclamp.png electriclamp
